...
# Parámetros
sensor_width = 24.0  # Ancho del sensor en mm
distance_to_object = 15000.0  # Distancia al objeto en mm (3 metros)
# Porcentaje del ancho del sensor que el objeto debe ocupar
object_percentage_on_sensor = 0.9

# Calcular longitud focal
focal_length = calculate_focal_length(sensor_width, 
                                      distance_to_object, 
                                      object_percentage_on_sensor
                                      )
print(f"La longitud focal de la cámara estenopeica debe ser de {focal_length:.2f} mm.")
