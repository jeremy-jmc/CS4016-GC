...
def cube_with_triangular_faces(full_path_output_file: str):
...
if __name__ == '__main__':
    cube_with_triangular_faces('cube_triangular_off.off')
    cube_with_triangular_faces('cube_triangular_ply.ply')